...
| nca-cscc-compliance-guide | pillar | critical-systems-hosting-checklist, cscc-log-retention-immutable-logs, cscc-backup-disaster-recovery, cscc-remote-access-controls, database-private-access-control | nca-ecc-compliant-hosting |
| *saudi-vision-2030-cloud **(NEW)** | pillar | nca-cscc-compliance-guide, *gcp-dammam-region-guide, *managed-hosting-ksa | cloudways-alternatives |
