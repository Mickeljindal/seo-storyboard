...
For the content-first alternative and the full comparison, [self-hosting Strapi](https://www.kloudbean.com/blog/self-host-strapi/). For the wider set of tools worth owning, the [best self-hosted tools](https://www.kloudbean.com/blog/best-self-hosted-tools/) guide. The database underneath is the important part: [managed PostgreSQL](https://www.kloudbean.com/blog/managed-postgresql-hosting/) or [managed MySQL](https://www.kloudbean.com/blog/managed-mysql-hosting/), kept safe with [server backups](https://www.kloudbean.com/blog/server-backups-guide/), with file assets in [object storage](https://www.kloudbean.com/blog/s3-compatible-object-storage/). Keeping connection details out of code is covered in [environment variables done right](https://www.kloudbean.com/blog/environment-variables-done-right/).
