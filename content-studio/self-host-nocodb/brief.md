...
- Managed engines used: MySQL, MariaDB, PostgreSQL (one-click, backups, private networking).
- Env vars in UI (Runtime Configuration), managed CI/CD from GitHub, private networking/VPC, automatic backups, Shorewall + Fail2ban, free SSL, FLB built-in.
