...
The line stays where it always is. Managed covers the server, the stack, TLS, backups, and patching. Your application code and your data remain yours, and a 505 you set on purpose lives in that half.
